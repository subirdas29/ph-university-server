...
router.get('/', (0, auth_1.default)(user_constant_1.USER_ROLES.superAdmin, user_constant_1.USER_ROLES.admin, user_constant_1.USER_ROLES.faculty), student_controller_1.StudentController.getAllStudent);
router.get('/:id', (0, auth_1.default)(user_constant_1.USER_ROLES.admin, user_constant_1.USER_ROLES.faculty), student_controller_1.StudentController.getOneStudent);
